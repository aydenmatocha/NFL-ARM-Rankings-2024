...
Win% (ESPN)
SOS (ESPN)
Point Differential (ESPN)
EPA/play (NFLfastR)
EPA/play Against (NFLfastR)
...
Sort team scores highest to lowest
```{r}
team_scores_sort <- team_scores %>% arrange(-Total_Value)
team_scores_sort
```
